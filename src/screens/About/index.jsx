    ...
    >
      ...
      <div className="w-1/2 space-y-[50px]">
        <div className="space-y-2">
          ...
          <p className="phone:text-sm phone:line-clamp-5">
            ...
            of Vietnam. Male. <br /> We hope to bring you closer to unique
            culinary values, helping you easily identify, enjoy and better
            understand the meaning of each dish. Join us to explore, feel and
            preserve the beauty of Vietnamese cuisine today! Start this
            flavorful journey now!
          </p>
        </div>
