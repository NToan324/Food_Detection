...
function Sidebar({ isOpen, handleNavigate }) {
  const menuItems = [
  ...
  return (
    <>
      <aside
        className={`opacity-0 max-w-[250px] menu-sidebar h-screen bg-white w-2/3 border-l border-t border-gray-light p-5 shadow-xl absolute top-[100px] right-0 transition duration-500 ease-in-out ${
